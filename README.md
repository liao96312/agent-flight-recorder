...
### Ignore Files From Workspace Scans

Add a `.afrignore` file at the workspace root when generated or bulky paths should not enter AFR's filesystem snapshots:
